...
const Header = () => {
 const { tenantInfo, currentUser, currentRole, selectedSeason, setSelectedSeason, updateProfile, publishAnnouncement } = useAuth();
 ...
 e.preventDefault();
 if (!annContent.trim()) {
 alert(' Mangyaring mag-input muna ng announcement text!');
 return;
 }
