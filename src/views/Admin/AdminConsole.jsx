...
const AdminConsole = ({ activeTab }) => {
 ...
 <div style={{ fontSize: '0.75rem', color: '#64748b' }}> {selectedUserDetail.email}</div>
 </div>
 ...
 <th style={{ padding: '12px 14px', textAlign: 'center', fontWeight: '800' }}> WRITE ENTRIES</th>
 <th style={{ padding: '12px 14px', textAlign: 'center', fontWeight: '800' }}> EXECUTE VALIDATIONS</th>
 <th style={{ padding: '12px 14px', textAlign: 'center', fontWeight: '800' }}> BYPASS AUDITS</th>
 ...
 <span> Start Date: <strong style={{ color: '#15803d' }}>{ann.startDate || ann.date}</strong></span>
 ...
 { id: 'governance', label: ' Executive & Security Governance' }
 ].map(scope => (
 <button
 key={scope.id}
 ...
 {selectedAnnouncement.startDate || selectedAnnouncement.date}
 </span>
 </div>
