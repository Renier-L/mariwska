...
const FarmStaffDashboard = ({ activeTab, setActiveTab }) => {
 ...
 deleteLivestock(id);
 alert(` Livestock group "${groupCode || id}" deleted and purged from Supabase!`);
 }
 };
 ...
 deleteCrop(id);
 alert(` Crop record "${variety}" deleted and purged from Supabase!`);
 }
 };
 ...
 setStaffNote('');
 alert(` Task #${selectedValidation.id} rejected / correction requested!`);
 };
 ...
 <span style={{ fontSize: '0.88rem', fontWeight: '800', color: '#0f172a' }}>
 {selectedLivestockDetail.healthStatus || selectedLivestockDetail.health || 'Excellent'}
 </span>
 </div>
 </div>
